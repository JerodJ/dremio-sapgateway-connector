...
@SourceType(value = "SAPGatewayARP", label = "SAPGateway",uiConfig = "sapgateway-layout.json")
public class SAPGatewayConf extends AbstractArpConf<SAPGatewayConf> {
  private static final String ARP_FILENAME = "arp/implementation/sapgateway-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sapgateway.SAPGatewayDriver";
